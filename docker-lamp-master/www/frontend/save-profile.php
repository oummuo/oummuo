...
//$genpass = md5($studentid);//
// if($userid and $studentid and $name and $nationality and $email and $address and $adviser){
    
    $sql = "UPDATE users
SET username='$studentid',password='$personalid',studentid='$studentid',name = '$name',personalid='$personalid',nationality='$nationality',email = '$email',address = '$address',adviser='$adviser'
WHERE id = '$userid'";
